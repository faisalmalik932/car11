                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" action="<?php echo base_url()?>admin_brands/submit" method="POST" enctype="multipart/form-data" >
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" name="name" class="form-control" value="<?php echo $bd->name?>" required>
                              </div>
                              <div class="form-group">
                                 <label>Email</label>
                                 <input type="email" name="email" class="form-control" value="<?php echo $bd->email?>" required>
                              </div>
                              <div class="form-group">
                                 <label>Mobile</label>
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="file" name="pic" value="<?php echo $bd->name?>">
