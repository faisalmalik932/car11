...
<a href="<?php echo base_url()?>admin_vehicle/image_list/<?php echo $vehicle->id;?>" class="btn btn-success btn-sm"><i class="fa fa-camera" style="color:white" aria-hidden="true"></i>
                                       ...
                                       <td>
                                          ...
                                          data-accessories_id="<?php echo $vehicle->accessories_id ?>"
                                          ...
                                          data-no_cylinders="<?php echo $vehicle->no_cylinders?>"
                                          data-mileage_city="<?php echo $vehicle->mileage_city?>"
                                          data-mileage_highway="<?php echo $vehicle->mileage_highway?>"
                                          data-fuel_capacity="<?php echo $vehicle->fuel_capacity?>"
...
$(document).on("click", ".btn_edit", function () {
     ...
     //alert(myBookId);
      ...
      $(".modal-vehicles-edit #accessories_id").val( accessories_id );
