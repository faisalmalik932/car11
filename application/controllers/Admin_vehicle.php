...
exit();*/
	...
	public function image_list()  //add_buyers() // show Testimonials
	{
	    ...
	    $idata['images'] = $this->Admin_vehicle_model->get_images($id);

		// $img = $this->Admin_vehicle_model->get_images($id);
	 //    // print_r($img);
  //    //    exit();
  //        $multi_img=$img[0]->multipleimages;
  //        $vehical_id=$img[0]->vehicle_id;
  //        $image_id=$img[0]->id;
  //        print_r($image_id);
  //        exit();
  //       if (!empty($multi_img))
  ...
  //          $multiple_images=vehicle_id;
		// 	$multiple_images = explode (",", $multi_img);
	...
	{
    $vehicle_id=$this->uri->segment(3);
		$vdata['records'] = $this->Admin_vehicle_model->get_vehicle($vehicle_id);
    print_r($vdata['records']);
        exit();
