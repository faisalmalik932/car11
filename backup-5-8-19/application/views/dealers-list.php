        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
             ...
             <a href="mailto:CarAdviserCorp@gmail.com">CarAdviserCorp@gmail.com</a> </div>
            <div class="header_widgets">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Inventory</a>
            ...
            <li class="dropdown active"><a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dealers</a>
              <ul class="dropdown-menu">
...
<section id="filter_form" class="gray-bg">
  <div class="container">
    <h3>Find Your Local Car Dealer <span>(Easy search from here)</span></h3>
    <div class="row">
      <form action="#" method="get">
		...
		<div class="form-group col-md-4 col-sm-6">
          <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i><a href="dealers-list.html" style="color: white;">Search Dealer</a> </button>
        </div>
  ...
  <div class="container">
      ...
      <div class="dealers_listing">
        <div class="row">
          ...
          <div class="col-sm-3 col-xs-12">
            <div class="view_profile"> <a href="dealers-profile.html" class="btn btn-xs outline">View Profile</a>
              <p>(25 Cars)</p>
            </div>
          </div>
        </div>
    ...
    <div class="pagination">
      <ul>
        ...
        <li><a href="dealers-list.html">2</a></li>
        <li><a href="dealers-list.html">3</a></li>
        <li><a href="dealers-list.html">4</a></li>
        <li><a href="dealers-list.html">5</a></li>
      </ul>
    </div>
  </div>
</section>
