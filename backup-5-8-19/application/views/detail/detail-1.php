  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9">
        <div class="listing_images">
          <div class="listing_images_slider">
            <div><img src="<?php echo base_url() ?>frontend/<?php echo base_url() ?>frontend/assets/images/listing_img4.jpg" alt="image"></div>
            <div><img src="<?php echo base_url() ?>frontend/assets/images/listing_img4.jpg" alt="image"></div>
            
          </div>
          <div class="listing_images_slider_nav">
            <div><img src="<?php echo base_url() ?>frontend/assets/images/listing_img3.jpg" alt="image"></div>
            <div><img src="<?php echo base_url() ?>frontend/assets/images/listing_img4.jpg" alt="image"></div>
        ...
        <div class="listing_more_info">
          ...
          <div class="listing_detail_wrap"> 
            <!-- Nav tabs -->
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview1 " aria-controls="vehicle-overview1" role="tab" data-toggle="tab">Vehicle Research </a></li>
              <li role="presentation"><a href="#specification1" aria-controls="specification1" role="tab" data-toggle="tab">Average Price History</a></li>
              <li role="presentation"><a href="#accessories1" aria-controls="accessories1" role="tab" data-toggle="tab">Vehicle Image History</a></li>
            </ul>
            
            <!-- Tab panes -->
            <div class="tab-content"> 
              <!-- vehicle-overview -->
              <div role="tabpanel" class="tab-pane active" id="vehicle-overview1">
                 <div class="table-responsive"> 
                  <!--Basic-Info-Table-->
                  <table>
                    <thead>
                    ...
                    <tbody>
                      <tr>
                        <td>$24,991 Listing price</td>
                        <td>$24,991 Listing price</td>
                      </tr>
                      <tr>
                        <td>$19,423 National average price</td>
                        <td>$21,973 Regional average price</td>
                      </tr>
                      <tr>
                        <td><h2 style="display: inline; color: darkslateblue;">$5,568 <i class="fa fa-arrow-circle-o-up" aria-hidden="true"></i></h2>  above average</td>
                        <td><h2 style="display: inline; color: darkslateblue;">$3,018 <i class="fa fa-arrow-circle-o-up" aria-hidden="true"></i></h2>  above average</td>
                      </tr>
                  ...
                  <table>
                    ...
                    <tbody>
                     ...
                     <th>Regional</th>
                      <tr>
                        <td>42,938 National average mileage</td>
                        <td>32,434 Regional average mileage</td>
                      </tr>
                      <tr>
                        <td>27,373 Actual mileage</td>
                        <td>27,373 Actual mileage</td>
                      </tr>
                      <tr>
                        <td><h2 style="display: inline; color: crimson;">$5,568 <i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></h2>  above average</td>
                        <td><h2 style="display: inline; color: crimson;">$3,018 <i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></h2>  above average</td>
                      </tr>
              ...
              <!-- Technical-Specification -->
              <div role="tabpanel" class="tab-pane" id="specification1">
                <div class="table-responsive"> 
                  <!--Basic-Info-Table-->
           ...
           <div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>             
              ...
              <!-- Accessories -->
              <div role="tabpanel" class="tab-pane" id="accessories1"> 
                <!--Accessories-->
                <table>
                  <thead>
                    <tr>
      ...
      <div class=" col-md-8 col-sm-3">
            ...
            <h4 class="text-center" style="color: black;">VIN Decoder & Vehicle History Check</h4>
      ...
      <div class=" col-md-8 col-sm-3">
            ...
            <div class="form-group ">
              ...
              <input type="number" class="form-control white_bg" placeholder="Lookup VIN number...!" id="number">
    ...
    <div class="row">
      ...
      <div class=" col-md-8 col-sm-3">
           ...
           <div class="form-group">
            <button class="btn center-block btn-block" type="submit">Search <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
      </div>
    </div>           
   </div>                       
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-address-card-o" aria-hidden="true"></i> Seller Contact </h5>
          </div>
          <div class="dealer_detail"> <img src="<?php echo base_url() ?>frontend/assets/images/dealer_img.jpg" alt="image">
      ...
      <div class="row">
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            <div class="product-listing-img"> <a href="#"><img src="<?php echo base_url() ?>frontend/assets/images/featured-img-3.jpg" class="img-responsive" alt="image" /> </a>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            <div class="product-listing-img"> <a href="#"><img src="<?php echo base_url() ?>frontend/assets/images/featured-img-1.jpg" class="img-responsive" alt="image" /> </a>
              <div class="label_icon">New</div>
              <div class="compare_item">
                <div class="checkbox">
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            <div class="product-listing-img"> <a href="#"><img src="<?php echo base_url() ?>frontend/assets/images/featured-img-2.jpg" class="img-responsive" alt="image" /> </a>
...
<script>Highcharts.chart('container', {
    ...
    series: [{
        ...
        data: [10000, 62000, 23050, 94400, 775400, 26300, 867600, 28400, 209200, 296000, 22000, {
            y: 23050,
            marker: {
                symbol: 'url(https://www.highcharts.com/samples/graphics/car.png)'
            }
        }, 94400, 775400, 26300, 867600]
        ...
        }, 10000, 62000, 23050, 94400, 775400, 26300, 867600, 28400, 209200, 296000, 22000]
    }]
});</script>
